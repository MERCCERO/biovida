                ...
                <table class="table-auto min-w-full rounded-xl">
                    <thead>
                        <tr class="bg-gray-50">
                            ...
                            <th scope="col" class="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize">Imágenes</th>
                            <th scope="col" class="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize">Modelado</th>
                    ...
                    <tbody class="divide-y divide-gray-300">
                        ...
                        <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                            <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">{{ $producto->id }}</td>
                            <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">{{ $producto->nombre }}</td>
                            <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">{{ $producto->descripcion }}</td>
                            <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">{{ $producto->precio }}</td>
                            <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">{{ $producto->existencia }}</td>
                            <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">{{ $producto->descuento }}</td>
                            ...
                            <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">{{ $producto->modelado }}</td>
                            <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                            ...
                            <td class="flex p-5 items-center gap-0.5">
                                <button onclick="window.location.href='/productos/{{$producto->id}}/editar'" class="p-2 rounded-full bg-white group transition-all duration-500 hover:bg-indigo-600 flex item-center">
                                ...
                                <button onclick="window.location.href='/productos/{{$producto->id}}/mostrar'" class="p-2 rounded-full bg-white group transition-all duration-500 hover:bg-red-600 flex item-center">
