    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="md:flex gap-x-24 clear-left md:mb-16 mb-10">
          <div class=" md:mb-0 mb-4">
              ...
              <p class="text-gray-600 text-lg font-normal leading-7 mb-7 md:text-left text-center">Ya sea que tenga una inquietud o simplemente quiera saludarnos, estamos aquí para facilitar la comunicación con usted.</p>
              <div class="flex md:items-center md:justify-start justify-center">
                  <button class="w-36 h-12 rounded-full bg-green-400 transition-all duration-700 hover:bg-green-600 shadow text-white text-center text-base font-semibold leading-6" onclick="window.location.href='{{ url('/help') }}';">Contactanos</button>
              </div>
          </div>
