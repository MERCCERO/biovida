...
<h2 class="flex flex-col justify-center items-center font-semibold text-black-700 rounded-lg mb-5">Clientes</h2>
                ...
                <table class="table-auto min-w-full rounded-xl">
                    ...
                    <tbody class="divide-y divide-gray-300 ">
                        ...
                        <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                            ...
                            <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 ">{{$cliente->id}}</td>
                            <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> {{$cliente->nombres}} </td>
                            <td class=" p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">{{$cliente->apellidos}}</td>
                            <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> {{$cliente->correo}}</td>
                            <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">{{$cliente->direccio}}</td>
                            <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> 
                                <div class="w-48 flex items-center gap-3">
                                <img src="{{$cliente->imagen}}" alt="{{$cliente->imagen}}".width="100">
                                <div class="data"></div>
                            ...
                            <td class="flex p-5 items-center gap-0.5">
                                ...
                                <button  onclick="window.location.href='/clientes/{{$cliente->id}}/editar'" class="p-2  rounded-full bg-white group transition-all duration-500 hover:bg-indigo-600 flex item-center">
                                ...
                                <button onclick="window.location.href='/clientes/{{$cliente->id}}/mostrar'" class="p-2 rounded-full bg-white group transition-all duration-500 hover:bg-red-600 flex item-center">
