...
{{--<div class="flex flex-col justify-between items-center w-full mb-4">
    <a href="{{ url('/registro') }}">
        <button type='button' class='py-2.5 px-6 text-sm rounded-lg border border-solid border-emerald-200 text-emerald-600 cursor-pointer font-semibold text-center shadow-xs transition-all duration-500 hover:bg-emerald-600 hover:text-white'>
            Crear Administrador
        </button>
    </a>
</div>--}}
<h2 class="flex flex-col justify-center items-center font-semibold text-black-700 rounded-lg mb-5">Administradores</h2>
                ...
                <table class="table-auto min-w-full rounded-xl">
                    <thead>
                        <tr class="bg-gray-50">
                            ...
                            <th scope="col" class="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize">nombres</th>
                            <th scope="col" class="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize">apellidos</th>
                            <th scope="col" class="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize">correo </th>
                            <th scope="col" class="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize">username </th>
                            ...
                            <th scope="col" class="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize">rol</th>
                    ...
                    <tbody class="divide-y divide-gray-300 ">
                        ...
                        <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                            ...
                            <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 ">{{$administrador->id}}</td>
                            <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> {{$administrador->nombres}} </td>
                            <td class=" p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">{{$administrador->apellidos}}</td>
                            <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> {{$administrador->correo}}</td>
                            <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">{{$administrador->username}}</td>
                            ...
                            <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 ">{{$administrador->rol}}</td>
                            <td class="flex p-5 items-center gap-0.5">
                                
                                <button  onclick="window.location.href='/administradores/{{$administrador->id}}/editar'" class="p-2  rounded-full bg-white group transition-all duration-500 hover:bg-indigo-600 flex item-center">
                                ...
                                @endif
                                <button onclick="window.location.href='/administradores/{{$administrador->id}}/mostrar'" class="p-2 rounded-full bg-white group transition-all duration-500 hover:bg-red-600 flex item-center">
